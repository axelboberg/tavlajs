...
module.exports = class View extends EventBus {
  ...
  /**
   * Set the composite operation to
   * be used when drawing this view
   * 
   * This is applied to the
   * globalCompositOperation property
  ...
  draw (ctx) {
    ...
    */
    ...
    /*
    Allow for different composite operations
    when drawing this view's children
    */
    ...
    if (this.clipping || this.compositeOperation) {
      ctx.restore()
    }
  }
